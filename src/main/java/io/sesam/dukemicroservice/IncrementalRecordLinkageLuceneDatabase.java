 ...
 */
public class IncrementalRecordLinkageLuceneDatabase implements Database {
    ...
    public IncrementalRecordLinkageLuceneDatabase() {
    ...
    /**
     * We implement this in order to ignore all records from the same dataset
     */
