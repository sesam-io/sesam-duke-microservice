 ...
 */
public class ThreadSafeJDBCLinkDatabase implements LinkDatabase {
  ...
  protected ThreadLocal<Statement> stmtTL = new ThreadLocal<>();
  private Logger logger;
  private static final SimpleDateFormat dtformat =
          new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");

  public ThreadSafeJDBCLinkDatabase(String driverklass,
                          String jdbcuri,
                          String dbtype,
                          Properties props) {
   ...
   */
  public void clear() {
    Statement stmt = getOrCreateStatement();
